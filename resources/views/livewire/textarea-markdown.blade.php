<div>
  ...
  <ul class="mb-5 inline-block text-sm">
    <li class="{{ $activeTab === 'write' ? 'border-blue-600 text-blue-600' : '' }} inline cursor-pointer rounded-l-md border px-3 py-1 pr-2 hover:border-blue-600 hover:text-blue-600"
